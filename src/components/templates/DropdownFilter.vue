        ...
        <div ref="dropdown">
          ...
          <ul class="mb-4">
            <li class="py-1 px-3">
              <label class="flex items-center">
                ...
                <span class="text-sm font-medium ml-2">Option 1</span>
              </label>
            </li>
            <li class="py-1 px-3">
              <label class="flex items-center">
                <input type="checkbox" class="form-checkbox" />
                <span class="text-sm font-medium ml-2">Option 2</span>
              </label>
            </li>
          </ul>
          <div class="py-2 px-3 border-t border-slate-200 bg-slate-50">
            <ul class="flex items-center justify-between">
              ...
              <li>
                <button class="btn-xs bg-indigo-500 hover:bg-indigo-600 text-white" >Apply</button>
