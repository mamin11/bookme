<template>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 flex h-screen items-center my-auto animate__animated animate__faster">
        <v-skeleton-loader
        v-if="loading"
        class="w-full max-w-xl p-5 relative mx-auto  rounded-xl shadow-lg  bg-white "
        v-bind="attrs"
