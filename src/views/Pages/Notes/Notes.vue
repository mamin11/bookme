<template>
<v-container fluid class="fill-height justify-center w-screen">
  <div class="w-full">
    <div v-if="editor" class="flex  justify-between overflow-scroll w-full">
    ...
    <editor-content :editor="editor" class="my-5 shadow-lg p-5" />
  </div>
</v-container>
</template>
