    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex justify-between items-center px-4 mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Your Customers</h1>
            </div>
...
<script>
import TeamsTable from '../../components/Customers/TeamsTable.vue';
import TeamsForm from '../../components/Customers/TeamsForm.vue';
...
export default {
    ...
    async getCustomersMaxPageSize() {
        const response = await axios.get(process.env.VUE_APP_API_URL + '/users/customers/page-size', {headers: {"Content-Type": "multipart/form-data"}})
